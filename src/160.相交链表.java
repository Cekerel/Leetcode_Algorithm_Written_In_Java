...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (pA != pB) {
             ...
             * 两个指针等于移动了相同的距离,有交点就返回, 无交点就是各走了两条指针的长度在这里第一轮体现在pA和pB第一次到达尾部会 移向另一链表的表头,
             * 而第二轮体现在如果pA或pB相交就返回交点不相交最后就是null==null
             */
            pA = pA == null ? headB : pA.next; // headA遍历完则直接接上headB继续遍历
            pB = pB == null ? headA : pB.next; // headB遍历完则直接接上headA继续遍历
        }
        return pA;
    }
}
