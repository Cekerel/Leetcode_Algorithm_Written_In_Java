...
class Solution {
    public String toGoatLatin(String S) {
        ...
        for (int i = 0; i < subStrings.length; i++) {
            if (isVowel(subStrings[i].charAt(0))) {
                builder.append(subStrings[i]);
            } else {
                builder.append(subStrings[i].substring(1) + subStrings[i].charAt(0));
            }
            builder.append("ma").append(suffix(i + 1)).append(" ");
        }
    ...
    public String suffix(int times) {
